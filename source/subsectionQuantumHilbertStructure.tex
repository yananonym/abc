...
Let $\mathcal{V}_{\text{valid}} \subset \mathbb{Z}^m_{\geq 0}$ denote the set of valid exponent vectors, and define the character group $\hat{\mathbb{Z}}^m_{\text{exponents}} = \prod_{j=1}^m \mathbb{T}_{p_j-1}$ as in Definition \ref{def:character-group}.
