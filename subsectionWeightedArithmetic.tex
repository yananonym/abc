...
Interestingly, scaling by a common factor $\lambda > 0$ does \emph{not change} the normalized weight vector, only the magnitude changes. This reflects the scale-invariance of probability distributions.
